        ...
        <div className="page">
            ...
            <nav className={`nav ${scrolled ? 'nav--scrolled' : ''}`}>
                ...
                <div className="nav-links">
                    ...
                    <a href="#cta" className="nav-btn">Începe acum</a>
                </div>
            </nav>
            ...
            <header className="hero" id="top">
                <div className="hero-inner">
                    ...
                    <div className="hero-btns">
                        <a href="#cta" className="btn-main">Creează un cont</a>
            ...
            <section className="cta" id="cta">
                ...
                <div className="cta-form">
                    <input type="email" placeholder="Email-ul tău" id="cta-email" />
                    <button type="button" id="cta-submit">Creează cont</button>
                </div>
